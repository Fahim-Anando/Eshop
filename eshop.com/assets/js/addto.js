...
let delete_button = document.getElementsByClassName('button-danger')

// picking up all the Add-To-Cart button
...
function addToCart(event){
    ...
    <td><button class="button button-danger" type="button">Remove</button></td>
`
